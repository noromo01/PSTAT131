...
#let's see which model did the best for each fit
select_by_one_std_err(knn_fit_titan,  desc(neighbors),  metric="roc_auc") #DOESN'T WORK, maybe I just shouldn't use
```